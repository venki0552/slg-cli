...
export default defineConfig({
	...
	head: [
		...
		[
			"meta",
			{ property: "og:title", content: "slg — Semantic git intelligence" },
		],
		[
			"meta",
			{
				...
				content:
					"Transform your git history into a queryable knowledge base for LLM agents.",
			},
		],
	],
	...
	themeConfig: {
		...
		nav: [
			...
			{ text: "Architecture", link: "/docs/architecture" },
			{
				...
				items: [
					{
						text: "Changelog",
						link: "https://github.com/venki0552/slg-cli/releases",
					},
		...
		socialLinks: [
			{ icon: "github", link: "https://github.com/venki0552/slg-cli" },
		],

		editLink: {
			pattern: "https://github.com/venki0552/slg-cli/edit/main/:path",
