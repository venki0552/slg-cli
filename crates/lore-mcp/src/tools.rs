...
pub fn get_tool_definitions() -> Vec<ToolDefinition> {
    vec![
        ...
        ToolDefinition {
            name: "lore_status".to_string(),
            description: "Get current lore index status.".to_string(),
            input_schema: json!({
                "type": "object",
                "properties": {}
            }),
...
mod tests {
    ...
    fn test_tool_definitions() {
        ...
        assert_eq!(tools[0].name, "lore_why");
        assert_eq!(tools[4].name, "lore_status");
    }
