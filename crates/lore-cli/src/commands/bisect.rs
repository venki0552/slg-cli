...
pub struct BisectArgs {
    /// Description of the bug to find
    pub bug_description: String,

    /// Max candidate commits to return
    #[arg(long, default_value = "5")]
    pub limit: u32,
}

/// Semantic bisect: find which commit likely introduced a bug.
pub async fn run(args: BisectArgs, format: OutputFormat, max_tokens: Option<usize>) -> Result<(), LoreError> {
