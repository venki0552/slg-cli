...
/// User configuration stored at ~/.lore/config.toml
...
impl LoreConfig {
    /// Load config from ~/.lore/config.toml.
    ...
    /// Write config to ~/.lore/config.toml.
    ...
    /// Returns the path to ~/.lore/config.toml
...
mod tests {
    ...
    fn test_config_roundtrip() {
        ...
        let deserialized: LoreConfig = toml::from_str(&serialized).unwrap();
