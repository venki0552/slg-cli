...
impl BM25Index {
    ...
    pub fn index_commit(store: &IndexStore, doc: &CommitDoc) -> Result<(), LoreError> {
        ...
        for (term, count) in &term_counts {
            ...
            .map_err(|e| LoreError::Database(format!("BM25 index_commit: {}", e)))?;
        }
        ...
        for term in term_counts.keys() {
            ...
            .map_err(|e| LoreError::Database(format!("BM25 doc_freq update: {}", e)))?;
        }
    ...
    pub fn search(
        ...
        for term in &query_tokens {
            ...
            let mut stmt = conn
                ...
                .map_err(|e| LoreError::Database(format!("BM25 search prepare: {}", e)))?;
